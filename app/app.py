...
# 🔐 USE ENV VARIABLES (SET IN EC2)
WEATHER_API_KEY = os.getenv("d624225ef53223f6fa372e4c2d33a2bf")
ORS_API_KEY = os.getenv("eyJvcmciOiI1YjNjZTM1OTc4NTExMTAwMDFjZjYyNDgiLCJpZCI6Ijg5NzcwZTI1OGRkNjRiYTE4OGJlNmFmMGE3ODAzOGQ0IiwiaCI6Im11cm11cjY0In0=")
OPENCAGE_KEY = os.getenv("e34780cae4f543569051cbab4cd013ce")
...
def get_coordinates(place):
    try:
        url = f"https://api.opencagedata.com/geocode/v1/json?q={place}&key={"e34780cae4f543569051cbab4cd013ce"}"
...
if start_area and end_area:
    ...
    if src_lat and dst_lat:
        ...
        st.sidebar.write(f"🌦️ Weather: {weather}")
        ...
        folium.Marker([dst_lat, dst_lon], tooltip="End",
